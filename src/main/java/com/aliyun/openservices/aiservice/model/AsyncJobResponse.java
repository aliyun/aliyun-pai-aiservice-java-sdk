...
public class AsyncJobResponse {
  ...
  @SerializedName("data")
  private Map<String, AsyncJobData> data = null;

  public AsyncJobResponse requestId(String requestId) {
  ...
  **/
  ...
  public AsyncJobResponse code(String code) {
    this.code = code;
    return this;
  }
  ...
  **/
  ...
  public AsyncJobResponse message(String message) {
  ...
  **/
  @Schema(description = "")
  public Map<String, AsyncJobData> getData() {
    return data;
  }

  public void setData(Map<String, AsyncJobData> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    AsyncJobResponse response = (AsyncJobResponse) o;
